...
import { authorizeFindingAction, createCapabilityRegistry } from "../extensions/findings-capabilities.ts";
import { initializeStore } from "../extensions/findings-store.ts";
